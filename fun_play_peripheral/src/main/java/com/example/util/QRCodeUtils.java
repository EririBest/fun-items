...
public class QRCodeUtils {
    ...
    public static String[] getSrc() throws Exception {
        ...
        String text = String.valueOf(num);  //这里设置二维码内容，即二维码扫出来后显示内容
        //LOGO中间图片
        String logoPath = "d:\\logo.jpg";
        //生成路径
        String destPath = "E:\\ewm";
        String[] values = {text,QRCodeUtils.encode(text, logoPath, destPath, true)};
        return values;
    }
}
